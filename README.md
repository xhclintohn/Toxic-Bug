...
<p align="center">
<img src="https://telegra.ph/file/16c27a981a3fb56409c26.jpg"/> 
<p align="center">
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=EB+Garamond&weight=800&size=28&duration=4000&pause=1000&random=false&width=435&lines=+_____TOXIC+B_____;WHATSAPP+CRASH+x+BUG+BOT;DEVELOPED+BY+xh_clinton;REALESE+DATE+21%2F6%2F2024." alt="Typing SVG" /></a>
</p>
<a><img src='https://i.imgur.com/LyHic3i.gif'/></a><a><img src='https://i.imgur.com/LyHic3i.gif'/></a>

### If you want to deploy somewhere else, upload your creds.json in session folder after getting pair code on replit. 

### 1. <a href="https://github.com/xhclintohn/Toxic-Bug/fork"><img src="https://img.shields.io/badge/FORK-blue" alt="Click Here to fork Venom-2" width="70"></a>
### 2. <a href="https://replit.com/@xhclintohn/Toxic-PairCode-1"><img src="https://img.shields.io/badge/PAIR_CODE-red" alt="Click Here to Get Pair-Code" width="90"></a>
...
### 4. <a href='https://replit.com/github/xhclintohn/Toxic-Bug' target="_blank"><img alt='Deploy On Replit' src='https://img.shields.io/badge/-Deploy On Replit-red?style=for-the-badge&logo=replit&logoColor=white'/></a>
...
#### COPY THESE COMMANDS AND PASTE IF YOU TRYING TO DEPLOY [ToxicBugBot](https://github.com/DeeCeeXxx/Venom-2) ON ANY TERMINAL
```
...
```
```
git clone https://github.com/type-your-username-here/Toxic-Bug
```
```
cd Venom-2
yarn install 
...
```cmd
> git clone https://github.com/xhclintohn/Toxic-Bug.git
```
```
> cd Toxic
```
